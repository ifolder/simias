...
public class POBoxService : System.Web.Services.Protocols.SoapHttpClientProtocol {
    ...
    /// <remarks/>
    [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://novell.com/simias/pobox/CreateSubscription", RequestNamespace="http://novell.com/simias/pobox/", ResponseNamespace="http://novell.com/simias/pobox/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
    ...
    /// <remarks/>
    public System.IAsyncResult BeginCreateSubscription(string subscription, System.AsyncCallback callback, object asyncState) {
        return this.BeginInvoke("CreateSubscription", new object[] {
                    subscription}, callback, asyncState);
    }
    
    /// <remarks/>
    public POBoxStatus EndCreateSubscription(System.IAsyncResult asyncResult) {
        object[] results = this.EndInvoke(asyncResult);
        return ((POBoxStatus)(results[0]));
    }
