...
//Find out those catalog nodes which are having collision and delete them.


public class DeleteCollisiionCatalogNodes 
{
	...
	static string CollisionProperty = "Collision";
	...
	public static void GetCollisionNodes( )
		...
		if(searchList != null && searchList.Count > 0)
		{
		 ...
		 else Console.WriteLine("No catalog node was found with collision!");
		}catch(Exception ee)
		{
