	...
	<form runat="server">
		...
		<div id="content">
			...
			<div class="main">
				...
				<div class="checkbox">
					<asp:checkbox ID="OverWriteCheckbox" onclick="ConfirmOverwrite(this)" runat="server" />
					<asp:Label ID="OverWriteExistingFile" Visible="true" runat="server" /><br>
				</div>	
				<div class="buttons">
