				...
				<asp:RadioButton ID="shared" runat="server" GroupName="SecurityGroup" AutoPostBack="true" /> <br> <br> 
				 ...
				 <div id="sub-content">
						...
						<div class="label">
							...
							<asp:DropDownList ID="RAList" runat="server" /> 
						</div>
						...
						<asp:TextBox ID="VerifyPassPhraseText"  TextMode="Password" runat="server" onkeydown="return SubmitKeyDown(event, 'CreateButton');"/><br>
						</div>
		        </div>		
