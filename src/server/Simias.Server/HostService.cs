...
namespace Simias.Host
{
	...
	public class HostService : WebService
	{
        ...
        /// <returns>member object if found, otherwise null</returns>
        ...
        /// </summary>
        /// <returns>member object, null on failure</returns>
	...
	public class HostAdmin : HostService
	{
		...
		/// <returns>property of new host as string</returns>
		[WebMethod(EnableSession = true)]
		...
		*/
		...
		/// </summary>
		/// <returns>owner's properties as string</returns>
		[WebMethod(EnableSession = true)]
