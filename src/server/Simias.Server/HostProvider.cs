...
using Simias.Server;
//using Simias.DomainService.Web;
...
namespace Simias.Host
{
	...
	public class SlaveSetup
	{
        ...
        /// <param name="sObject">object to be committed</param>
        ...
        /// <returns>string object for the document</returns>
        ...
        /// <summary>
        /// Get the domain from tempDomainFileName
        /// </summary>
        /// <param name="storePath">path</param>
        ...
        /// <summary>
        /// Save domain to the path inside file tempDomainFileName
        /// </summary>
        /// <param name="storePath">path of the store</param>
        /// <param name="domain">domain as string</param>
        ...
        /// </summary>
        /// <param name="storePath">path</param>
        /// <param name="owner">owner as string object</param>
        ...
        /// <summary>
        /// save host into tempPPKFileName
        /// </summary>
        /// <param name="storePath">path</param>
        /// <param name="host">host as string object</param>
		...
		/// <summary>
        /// save the rsa keys,domain, owner, host
		/// </summary>
		...
		/// <summary>
		/// Delete all temp files used foe keys, owner etc
		/// </summary>
		/// <param name="storePath">path</param>
