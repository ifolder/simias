...
namespace Simias.Client
{
	...
	public class Manager
	{
			...
			get
			{
				...
				catch
				{
					// Use the relative default path;
                                        ...
                                        applicationPath = (MyEnvironment.Windows ? "./lib/simias/web/bin/Simias.exe" :
                                                (( MachineArch == null )? "../lib/simias/web/bin/Simias.exe": "../lib64/simias/web/bin/Simias.exe"));
				}
		...
		public string Start()
		{
			...
			{
				simiasProcess.Kill();
				throw new ApplicationException( "Start:Timed out waiting for Simias process to start." );
			}
		...
		public bool Stop()
		{
			...
			{
				simiasProcess.Kill();
				throw new ApplicationException( "Stop:Timed out waiting for Simias process to start." );
			}
